...
def part1_data_analysis(file_path):
    ...
    plt.title('Total Quantity Sold per Product (总产品销量)')
    plt.xlabel('Product (产品)')
    plt.ylabel('Total Quantity Sold (总销售数量)')
    ...
    if not df_2023.empty:
        ...
        plt.title('Total Sales Over Time (2023) (2023 年月度总销售趋势)')
        plt.xlabel('Month (月份)')
...
def part3_neural_network():
    ...
    plt.title('Training Loss Over Epochs (训练损失随周期变化)')
    plt.xlabel('Epoch (周期)')
    plt.ylabel('Loss (MSE)')
    plt.grid(True)
    plt.tight_layout()
...
# 设置 Matplotlib 样式import pandas as pd
# import matplotlib.pyplot as plt
# import sqlite3
# import torch
# import torch.nn as nn
...
# --- Part 3: 基本神经网络定义import pandas as pd
# import matplotlib.pyplot as plt
# import sqlite3
# import torch
# import torch.nn as nn
